# Aula 12 — Caveman + Spec-Kit: Comunicação Enxuta no Desenvolvimento com IA

**Data:** 09/11/2026 | **Horário:** 11h20 às 13h00 | **Local:** Lab 207 | **Modalidade:** Presencial

[Baixar / Copiar Código Fonte da Aula](https://raw.githubusercontent.com/paulossjunior/aula-extensao/main/docs/plano-de-aula/aulas/aula-12-2026-11-09.md)

---

## Introdução

Na [Aula 09](../../plano-de-aula/aulas/aula-09-2026-10-05.md), trabalhamos com **Spec-Driven Development** para reduzir ambiguidade antes de pedir código a um agente de IA. A ideia era simples: se a especificação é melhor, o código gerado tende a ser mais previsível. Na [Aula 10](../../plano-de-aula/aulas/aula-10-2026-10-19.md), demos ao agente o contexto do projeto com `AGENTS.md` e instalamos capacidades reutilizáveis com o skills.sh. Hoje vamos adicionar uma camada operacional ao fluxo: usar **Caveman** — que é, ele próprio, um skill — para revisar, resumir e controlar a verbosidade do agente em cada fase do **Spec-Kit**.
...
- [Aula 10 — AGENTS.md, Spec-Kit e skills.sh](../../plano-de-aula/aulas/aula-10-2026-10-19.md)
...
### Comandos e níveis de concisão

O Caveman organiza a compressão em **três níveis**, e a escolha entre eles é a decisão que importa:

1. **Lite** — remove enrolação, mantém gramática normal. Bom para respostas profissionais e explicações ao grupo.
2. **Full** — frases curtas e fragmentos. Bom para depuração rápida e revisão técnica.
3. **Ultra** — resposta telegráfica. Bom para comandos, diagnósticos simples e listas de ação.

Além dos níveis, há comandos auxiliares para commit, revisão de PR, estatísticas de economia e compressão de arquivos de memória.
...
!!! abstract "A tabela de comandos está na referência"
    Todos os comandos — `/caveman lite|full|ultra`, `/caveman-commit`, `/caveman-review`, `/caveman-stats`, `/caveman:compress` e `caveman-shrink` —, com a finalidade e um exemplo de uso de cada um, estão em **[Referência — Caveman](../../referencia/caveman.md)**.
...
Cada fase do Spec-Kit pede um tipo diferente de revisão, e cada uma tem um prompt pronto: constitution, spec, plano, tasks, implementação e relatório final. O padrão é sempre o mesmo — **escolher o nível de concisão, dizer o que listar e fixar o formato da saída**:
...
As três linhas fazem trabalho distinto: a primeira escolhe o nível, a segunda delimita o escopo da revisão, e a lista fixa o que se espera de volta. Sem a terceira, o agente escolhe sozinho o que considerar relevante.

!!! abstract "Os seis prompts estão na referência"
    Prompts prontos para revisar constitution, spec, plano técnico, tasks e implementação, mais o de relatório final da feature, estão em **[Referência — Caveman](../../referencia/caveman.md)**. Use na Tarefa 3.
