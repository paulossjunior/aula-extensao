# EaD 07 — Desenvolvimento Ágil, Arquitetura Inicial e Planejamento com DSM

**Data:** 22/09/2026 | **Horário:** 13h50 às 16h30 | **Local:** 💻 EaD | **Modalidade:** A distância — estudo guiado

[⬇️ Baixar / Copiar Código Fonte da Aula](https://raw.githubusercontent.com/paulossjunior/aula-extensao/main/docs/plano-de-aula/aulas/ead-07-2026-09-22.md)

---

!!! note "Como esta sessão funciona"
    Este conteúdo era a Aula 07 presencial e passou a ser **estudo guiado na sessão EaD de terça, 22/09**. A segunda-feira 21/09 ficou com [GitFlow, Versionamento Semântico e CI/CD com GitHub Actions](aula-07-2026-09-21.md).

    O material abaixo é autoexplicativo: leia as seções de conceito, execute as quatro tarefas com o grupo e leve as dúvidas para o professor na aula seguinte. O exercício correspondente continua valendo e vence em **Seg, 28/09** — ver [Especificação de Entregas](../../entregas/index.md#ead-07-montar-backlog-features-fim-a-fim-e-dsm).
...
- [Exemplo de DSM com Loop e Erro de Planejamento](../../modelos/dsm-exemplo-loop-erro.md)
...
Nesta sessão, demos o primeiro passo para transformar propostas validadas em execução organizada. Introduzimos os fundamentos do **desenvolvimento ágil com Scrum**, discutimos a importância de pensar em **features fim a fim** e usamos o **DSM** para visualizar dependências e apoiar a definição da arquitetura inicial.

O backlog e a DSM produzidos aqui são insumo direto de aulas posteriores: a [Aula 09](aula-09-2026-10-05.md) escreve a especificação de uma feature deste backlog, e a [Aula 14](aula-14-2026-11-23.md) usa a DSM para decidir o que pode rodar em paralelo.
...
!!! note "Tarefa de Casa — Preparar a Execução"
    ...
    5. Preparar a apresentação do protótipo validado para a **Aula 08, em 28/09/2026** — apresentação do trabalho e Checkpoint Prático 2.
