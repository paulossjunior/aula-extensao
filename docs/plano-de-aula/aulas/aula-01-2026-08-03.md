...
| 3 — Construir | Aula 09 (Spec-Driven Development), Aula 10 (AGENTS.md, Spec-Kit e skills.sh), Aula 12 (Caveman + Spec-Kit), Aula 13 (Epics, User Stories e Gherkin), Aula 14 (CrewAI) |
| 4 — Operar e monitorar | Ao longo do trabalho de grupo, com o produto no ar e observado. A Aula 16 traz uma aula extra sobre Hermes Agent, sem entrega |
