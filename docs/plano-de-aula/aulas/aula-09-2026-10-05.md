...
- [Aula 07 — Scrum, Features Fim a Fim e DSM](../../plano-de-aula/aulas/aula-07-2026-09-21.md)
...
O trabalho da Aula 07 alimenta diretamente o que vamos fazer hoje:
...
```mermaid
flowchart TD
    A[Problema validado<br/>Aulas 01–04] --> B[Backlog + Features fim a fim + DSM<br/>Aula 07]
...
Cada grupo escolhe **uma única feature** do backlog produzido na Aula 07 — preferencialmente uma feature fim a fim de tamanho médio, nem trivial nem gigante.
...
3. Pegar a **DSM** da Aula 07 e comparar: a ordem que o agente propôs respeita as dependências mapeadas pelo grupo? Onde diverge?
