...
| Nº | Data | Horário | Local | Conteúdo |
|----|------|---------|-------|----------|
...
| —    | Seg, 12/10/2026 | — | — | 🚫 **Feriado — sem aula** — Nossa Senhora Aparecida (nacional) |
...
| **Aula 12** | Seg, 09/11/2026 | 11h20–13h00 | Lab 207 | [Caveman + Spec-Kit: Comunicação Enxuta no Desenvolvimento com IA](../plano-de-aula/aulas/aula-12-2026-11-09.md) |
...
!!! danger "Fechamento do semestre"
    ...
    - **Ter, 08/12/2026** é o **prazo final** para entregar qualquer pendência: exercícios, atividades individuais, documentação do portal e o produto em produção. Nada é aceito depois dessa data.
    - **Seg, 14/12/2026** é a **prova final**, presencial no Lab 207. Não é prova escrita: é um **trabalho individual cobrindo todo o conteúdo da disciplina**, e é uma avaliação **à parte dos 100 pontos**. Ocorre após o término regular do semestre (11/12). Detalhes em [Avaliação](../avaliacao/avaliacao.md#prova-final).

!!! tip "Observações"
    - As aulas poderão ser reagendadas em caso de feriado adicional ou necessidade acadêmica.
    - As sessões **EaD** não têm conteúdo novo: são dedicadas à execução dos exercícios e do trabalho de extensão.
