...
| [EaD 07](../plano-de-aula/aulas/ead-07-2026-09-22.md) | Ter, 22/09 | `aula-07-scrum-e-dsm` | **Seg, 28/09** |
...
### EaD 07 — Montar backlog, features fim a fim e DSM
...
Toda última segunda-feira do mês há apresentação do trabalho, sem conteúdo novo: **31/08**, **28/09**, **26/10** e **30/11**. Na primeira delas o grupo entrega também a **proposta de produto no Figma Maker**.

Nas mesmas quatro datas acontece a **entrevista individual**. Cada checkpoint resulta em passou ou não passou, e **é preciso passar nos quatro** para receber os 50 pontos do trabalho em grupo. Por ser presencial e pontual, a entrevista **não entra na política de reenvio** descrita abaixo.

!!! warning "Não há margem para falta"
    Faltar a um checkpoint sem justificativa custa os 50 pontos do grupo. Havendo motivo justificado, **combine a reposição com o professor antes da data**.

!!! abstract "A pontuação vive na página de Avaliação"
    Os cinco itens de 10 pontos do trabalho em grupo, o formato da entrevista e o escopo de cada checkpoint estão em **[Avaliação](../avaliacao/avaliacao.md)**. Esta página trata só da mecânica: o que entregar, onde e até quando.
